...
<div class="row">
  <div class="col-md-12">
    <table class="table">
      ...
      <tbody>
        <tr>
          <td><?php echo $rows_menu['id'];?></td>
          <td><?php echo $rows_menu['name'];?></td>
          <td><?php echo $rows_menu['category'];?></td>
          <td><?php echo $rows_menu['price']; ?></td>
          <td><?php echo $rows_menu['description']; ?></td>
          <td> 
