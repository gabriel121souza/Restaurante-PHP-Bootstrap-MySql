...
<br>
    ...
    <div class="page-header">
        <form method="POST" action="manager/proce_cad_manager.php">
            <label>Nivel de Acesso</label>
            <input class="form-control" type="text" name="nivel_acesso_id" value="2" readonly required>       
            ...
            <div class="form-group">
                ...
                <small id="emailHelp" class="form-text text-muted">Digite o email autentico.</small>
            </div>

            <div class="form-group">
                <label>Usuario</label>
                <input type="usuario" name="user" class="form-control" placeholder="digite seu usuario" required>
